...
public class DBInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        inventarioPlanetaRepository.saveAll(inventarioPlaneta);/*
                                                                ...
                                                                * for (int i = 0; i < 100; i++) {
                                                                * Jugador jugador = new Jugador("a" + i, "usuario" + (i
                                                                * + 1), "hola");
                                                                ...
                                                                * for (int i = 0; i < 10; i++) {
                                                                * Nave nave = new Nave(random.nextInt(900) + 100,
                                                                * random.nextDouble(400) + 50,
                                                                * random.nextDouble(400) + 50, random.nextDouble(400) +
                                                                * 50, "nave" + i, random.nextDouble(200) + 15);
                                                                * naves.add(nave);
                                                                * }
                                                                * 
                                                                ...
                                                                * Estrella estrella = new Estrella(random.nextDouble() *
                                                                * 100, random.nextDouble() * 100,
                                                                * random.nextDouble() * 100);
                                                                * estrellas.add(estrella);
                                                                * 
                                                                * // Agregar planetas aleatoriamente al 1% de las
                                                                * estrellas
                                                                * if (i % 100 == 0 && i > 0) {
                                                                * int numPlanets = random.nextInt(3) + 1;
                                                                * for (int j = 0; j < numPlanets; j++) {
                                                                * Planeta planeta = new Planeta("planeta" + i + "_" +
                                                                * j);
